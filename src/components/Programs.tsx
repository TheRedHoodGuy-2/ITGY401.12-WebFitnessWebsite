    ...
    <section id="programs" className="py-24 bg-neutral-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {programs.map((program, index) => (
            ...
            >
              ...
              <div className="p-6">
                ...
                <button className="text-orange-600 hover:text-orange-500 flex items-center gap-2 group/btn transition-colors">
                  Learn More
        ...
        <div className="text-center mt-12">
          <button className="bg-transparent border-2 border-orange-600 text-orange-600 px-8 py-4 rounded-full hover:bg-orange-600 hover:text-white transition-all">
            View All Programs
          </button>
        </div>
      </div>
